...
#
# # ------------ 主流程 ------------
# # input_tif = r'C:/NTL-CHAT/SGDSAT-1/KX10_GIU_20220304_E121.82_N31.56_202200100146_L4A/' \
# #             'KX10_GIU_20220304_E121.82_N31.56_202200100146_L4A_A_LH.tif'
# input_tif = "C:/NTL_Agent/Night_data/SDGSAT-1/roads_binary_t.tif"
# output_mask = 'C:/NTL_Agent/Night_data/SDGSAT-1/roads_binary.tif'
#
# # 1. 读取第一个波段
...
#
# # 用户配置
# input_tif  = r'C:/NTL_Agent/Night_data/SDGSAT-1/roads_binary_t.tif'   # 替换为你的灰度图路径
# output_tif = r'C:/NTL_Agent/Night_data/SDGSAT-1/otsu_roads_binary2.tif'              # 输出二值化道路掩模
#
# # 1. 读取单波段灰度图
# with rasterio.open(input_tif) as src:
